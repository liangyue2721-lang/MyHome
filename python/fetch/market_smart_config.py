...
MAX_RETRIES = 3
RETRY_BACKOFF = 2
AUCTION_INTERVAL = 30       # 集合竞价采集间隔(秒)
TICK_INTERVAL = 15          # 盘口快照采集间隔(秒)
SENTIMENT_INTERVAL = 300    # 情绪指标采集间隔(秒)
...
CONSECUTIVE_BOARD_URL = "https://push2ex.eastmoney.com/getTopicQSPool"  # 连板股池
YESTERDAY_ZT_URL = "https://push2ex.eastmoney.com/getYesterdayZTPool"  # 昨日涨停
LIMIT_POOL_PARAMS = {
